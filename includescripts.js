...
var includeScripts = function (depFiles, onload, onerror) {
    ...
    function pathsEq (p1, p2) {
        var paths = [p1, p2];
        paths = paths.map(function (x, i, a, t){
...
include.includeScripts = includeScripts;

// helper function to create script nodes
var _createNode = function (onload, onerror, missingFiles, recurse) {

        // list all script elements
        var a = document.getElementsByTagName('SCRIPT'),

                // get currently running script, it's parent and a new script node
        ...
        script.onload = (function (s, t, p){return function (){
        
            // perform chain of onload callbacks or recursively include further scripts
            missingFiles.length === 1 ? ((!!onload) ? onload() : {} ): recurse();        
        ...
        script.onerror = (function (s, t, p){return function (){
